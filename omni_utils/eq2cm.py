# This file is copied from `https://github.com/sunwei925/MC360IQA` which is offical repo
# of paper `MC360IQA: A Multi-channel CNN for Blind 360-degree Image Quality Assessment`
