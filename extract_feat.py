...
def extract_feat_video(extractor: HierarchicalFeatureExtractor,
                       vidpath: Path, frame_num: int, max_idx: int, batch_size: int = 10):
...
def extract_feat_img(extractor: HierarchicalFeatureExtractor, VPSpath: Path, vname, VP_idx: int,v_length: int,
                     batch_size: int = 10):
    frames = []
...
if __name__ == "__main__":
    ...
    save_dir = Path(f"./cache/features/{args.database}")
